...
// 5000000000000
#[test]
fn test_swap_exact_amount_out_with_incentive() {
    ...
    cp.swap_exact_amount_in(
        MsgSwapExactAmountIn {
            ...
            token_out_min_amount: amount_in_before_fee.to_string(),
        },
        &t.accounts["swapper"],
    )
    .unwrap();
...
fn verify_contract_balances(
    ...
    dbg!("before swap", &pool_liquidity);
