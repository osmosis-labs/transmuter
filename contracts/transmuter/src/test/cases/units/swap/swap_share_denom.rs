...
fn test_swap_exact_amount_in_with_share_denom() {
    ...
    test_swap_share_denom_success_case(
        ...
        SwapMsg::SwapExactAmountIn {
            token_in: coin(1_000, "denom0".to_string()),
            token_out_denom: share_denom.clone(),
            token_out_min_amount: Uint128::one(),
        },
        coin(1_000, "denom0".to_string()),
        coin(1_000, share_denom.clone()),
    );

    test_swap_share_denom_success_case(
        &t,
        SwapMsg::SwapExactAmountIn {
            token_in: coin(1_000, share_denom.clone()),
            token_out_denom: "denom1".to_string(),
            token_out_min_amount: Uint128::one(),
        },
        coin(1_000, share_denom),
        coin(1_000, "denom1".to_string()),
    );
}
...
fn test_swap_exact_amount_in_with_share_denom_and_normalization_factor() {
    ...
    let t = pool_with_single_lp(
        ...
        vec![
            coin(REMAINING_DENOM0, "denom0"),
            coin(REMAINING_DENOM1 * 10u128.pow(8), "denom1"),
        ],
        vec![AssetConfig {
    ...
    test_swap_share_denom_success_case(
        &t,
        SwapMsg::SwapExactAmountIn {
            token_in: coin(1_000 * 10u128.pow(8), "denom1".to_string()),
            token_out_denom: share_denom.clone(),
            token_out_min_amount: Uint128::one(),
        },
        coin(1_000 * 10u128.pow(8), "denom1".to_string()),
        coin(1_000, share_denom.clone()),
    );
    ...
    test_swap_share_denom_success_case(
        &t,
        SwapMsg::SwapExactAmountIn {
            token_in: coin(1000, share_denom.clone()),
            token_out_denom: "denom1".to_string(),
            token_out_min_amount: Uint128::one(),
        },
        coin(1000, share_denom),
        coin(1000 * 10u128.pow(8), "denom1".to_string()),
    );
}
...
fn test_swap_exact_amount_out_with_share_denom() {
    ...
    test_swap_share_denom_success_case(
        ...
        SwapMsg::SwapExactAmountOut {
            ...
            token_out: coin(1_000, share_denom.clone()),
        },
        coin(1_000, "denom0".to_string()),
        coin(1_000, share_denom.clone()),
    );
    ...
    test_swap_share_denom_success_case(
        ...
        SwapMsg::SwapExactAmountOut {
            ...
            token_in_max_amount: Uint128::from(1_000u128),
            token_out: coin(1_000, "denom1".to_string()),
        },
        coin(1_000, share_denom),
        coin(1_000, "denom1".to_string()),
    );
...
fn test_swap_exact_amount_out_with_share_denom_single_asset_pool() {
    let app = osmosis_test_tube::OsmosisTestApp::new();
    let t = pool_with_single_lp(&app, vec![coin(REMAINING_DENOM0, "denom0")], vec![]);
    ...
    test_swap_share_denom_success_case(
        ...
        SwapMsg::SwapExactAmountOut {
            token_in_denom: share_denom.clone(),
            token_in_max_amount: Uint128::from(1_000u128),
            token_out: coin(1_000, "denom0".to_string()),
        },
        coin(1_000, share_denom.clone()),
        coin(1_000, "denom0".to_string()),
    );
...
fn test_swap_exact_amount_in_with_share_denom_and_normalization_factor_single_asset() {
    ...
    let t = pool_with_single_lp(
        &app,
        vec![coin(REMAINING_DENOM1 * 10u128.pow(8), "denom1")],
        vec![AssetConfig {
            denom: "denom1".to_string(),
            normalization_factor: 10u128.pow(8).into(),
        }],
...
fn test_swap_exact_amount_out_with_share_denom_where_token_in_max_is_exceeding_expectation() {
    ...
    test_swap_share_denom_success_case(
        ...
        SwapMsg::SwapExactAmountOut {
            ...
            token_out: coin(1_001, share_denom.clone()),
        },
        coin(1_001, "denom0".to_string()),
        coin(1_001, share_denom.clone()),
    );
